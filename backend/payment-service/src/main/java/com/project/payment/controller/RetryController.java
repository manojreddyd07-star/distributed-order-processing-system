...
import com.project.payment.dto.RetryRecordDTO;
import com.project.payment.entity.RetryRecordEntity;
...
public class RetryController {
    ...
    /**
     * Convert RetryRecordEntity to RetryRecordDTO
     */
    private RetryRecordDTO convertToDTO(RetryRecordEntity entity) {
        return new RetryRecordDTO(
            ...
            entity.getRetryStatus(),
            entity.getLastRetryTime(),
